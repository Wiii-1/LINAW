...
const networkIdParam = joi
  .object({
    id: objectIdlike.required(),
  })
  .required();

const channelIdParam = joi
  .object({
      ...
      .object({
        ...
        resources: joi
          .object({
            ...
            orderer: resourceLimitSchema.default({
              cpus: "0.25",
              memory: "256M",
            }),
...
const channelReadSchema = joi
  .object({
    params: networkIdParam,
  })
  .required();

const smartContractSchema = joi
  .object({
...
const contractReadAllSchema = joi
  .object({
    params: channelIdParam,
  })
  .required();
