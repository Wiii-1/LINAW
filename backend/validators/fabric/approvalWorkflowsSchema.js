...
const submitForApproval = joi
  .object({
    params: submissionId,
  })
  .required();

const approveSubmission = joi
  .object({
    params: submissionId,
    body: joi
      .object({
